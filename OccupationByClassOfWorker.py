...
# gets the collection
cols = db['OccupationByClassOfWorker']
...
def reKeyData(data):
    ...
    old = census_request.getOccupationKeys()
    new_dict = {}
    n = 0
    for d in old:
        x = []
...
def getStringKeys():
    new = (
        ...
        "Sales and office occupations", "Service occupations", "Management, business, science, and arts occupations", "Total"
    )
